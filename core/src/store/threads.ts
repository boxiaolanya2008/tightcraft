 ...
 *
 * 单例 threadStore 供 CLI chat / TUI 会话复用。无持久化，进程重启即清空。
 */

import { randomUUID } from "node:crypto";
import type { ToolRecord } from "../engine/types";
...
export class ThreadStore {
  ...
  append(threadId: string, msg: Omit<Message, "id" | "createdAt">): Message | undefined {
